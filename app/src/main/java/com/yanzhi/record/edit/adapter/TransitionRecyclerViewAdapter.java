...
public class TransitionRecyclerViewAdapter extends RecyclerView.Adapter<TransitionRecyclerViewAdapter.ViewHolder>  {
    ...
    public TransitionRecyclerViewAdapter(Context context, ArrayList<FxManageActivity.FxInfoDescription> fxInfoList) {
        m_mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(m_mContext).inflate(R.layout.item_transition, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mTextImage = (ImageView) itemView.findViewById(R.id.transition_Image);
            mTextName = (TextView) itemView.findViewById(R.id.transition_Name);
            mImageBorder = (LinearLayout) itemView.findViewById(R.id.transitionImage_Border);
        }
    }
}
